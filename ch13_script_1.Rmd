...
nes %>% 
  ...
  labs(x = "Income", y = "Preference for Demcratic Candidate")
...
Baysian: There's a 7% difference between for the democrat than for people that vote between 3-4. It is somewhere between 6-8%
Frequentist: Repeating this experiment over and over, 95% the true value lies between these values.
...
If I take the whole US population, people one bucket higher are about 7% less likely to vote for democrat. I am 6-8% percent sure about this! The more money you have, the less likely you are to vote for Democrats.
